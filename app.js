...
app.post("/insertarRegistro2", async (req, res) => {
  try {
    // Obtener el id_usuario de la cookie de sesión
    const id_usuario = req.session.user.id; // Suponiendo que el ID de usuario se almacena en req.session.user
    ...
    await connection.execute(insertQuery, [
      id_usuario,
      fecha_creacion,
      2, // Asignar el valor de id_tipo_registro según sea necesario
    ]);
...
app.post("/insertarRegistro3", async (req, res) => {
  try {
    // Obtener el id_usuario de la cookie de sesión
    const id_usuario = req.session.user.id; // Suponiendo que el ID de usuario se almacena en req.session.user
    ...
    await connection.execute(insertQuery, [
      id_usuario,
      fecha_creacion,
      3, // Asignar el valor de id_tipo_registro según sea necesario
    ]);
...
app.get("/formulario15", auth, (req, res) => {
  res.render("formulario15");
});

app.get("/formulario16", auth, (req, res) => {
  res.render("formulario16");
});

app.get("/formulario17", auth, (req, res) => {
  res.render("formulario17");
});

app.get("/formulario18", auth, (req, res) => {
  res.render("formulario18");
});

app.get("/formulario19", auth, (req, res) => {
  res.render("formulario19");
});

app.get("/formulario20", auth, (req, res) => {
  res.render("formulario20");
});

app.get("/formulario21", auth, (req, res) => {
  res.render("formulario21");
});

app.get("/formulario22", auth, (req, res) => {
...
app.get("/formulario31", auth, (req, res) => {
  res.render("formulario31");
});

app.get("/formulario32", auth, (req, res) => {
  res.render("formulario32");
});

app.get("/formulario33", auth, (req, res) => {
